...
public:
     ...
     *
     * \param data Dane wejściowe, na podstawie których wyznaczana jest suma kontrolna
     * \param length Długość danych wejściowych
     * \return crc Obliczona suma kontrolna
     */
...
private:
    //! Prywatna zmienna
    /*!
     * Tabela poszukiwań używana w implementacji CRC16 w celu przyspieszenia obliczeń.
